 ...
 */
public class CreateCustomPropertyAliasDefinitionPanel extends VerticalLayout {

    private UserClientInfo currentUserClientInfo;
    private String businessSolutionName;
    private Window containerDialog;
    private CustomPropertyAliasNameDefinitionManagementPanel relatedCustomPropertyAliasNameDefinitionManagementPanel;
    ...
    public CreateCustomPropertyAliasDefinitionPanel(UserClientInfo userClientInfo){
        this.currentUserClientInfo=userClientInfo;
        setSpacing(true);
        setMargin(true);
        MainSectionTitle addNewPropertySectionTitle=new MainSectionTitle("添加自定义属性别名");
    ...
    public void addNewCustomPropertyAliasName(){
        ...
        boolean isExistTypePropertyName= BusinessSolutionOperationUtil.
                checkCustomPropertyAliasDefinitionExistence(getBusinessSolutionName(), customPropertyNameStr, dataFieldTypeObj.toString());
        if(isExistTypePropertyName){
            String checkErrorMessage="业务解决方案 "+getBusinessSolutionName()+" 中已经存在自定义属性 "+customPropertyNameStr+" 的别名";
        ...
        String confirmMessageString=" 请确认在业务解决方案 "+getBusinessSolutionName()+" 中添加自定义属性 "+customPropertyNameStr+" ("+customPropertyTypeStr+")"+" 的别名 "+customPropertyAliasNameStr;
        ...
        final CreateCustomPropertyAliasDefinitionPanel self=this;
        Button.ClickListener confirmButtonClickListener = new Button.ClickListener() {
            @Override
            public void buttonClick(final Button.ClickEvent event) {
                //close confirm dialog
                addTypePropertyConfirmDialog.close();
                boolean createTypePropertyResult= BusinessSolutionOperationUtil.
                        addCustomPropertyAliasDefinition(getBusinessSolutionName(),customPropertyNameStr,customPropertyTypeStr,customPropertyAliasNameStr);
                if(createTypePropertyResult){
                    self.containerDialog.close();
                   getRelatedCustomPropertyAliasNameDefinitionManagementPanel().addNewCustomPropertyAliasName(customPropertyNameStr,customPropertyTypeStr,customPropertyAliasNameStr);
    ...
    public CustomPropertyAliasNameDefinitionManagementPanel getRelatedCustomPropertyAliasNameDefinitionManagementPanel() {
        return relatedCustomPropertyAliasNameDefinitionManagementPanel;
    }

    public void setRelatedCustomPropertyAliasNameDefinitionManagementPanel(CustomPropertyAliasNameDefinitionManagementPanel relatedCustomPropertyAliasNameDefinitionManagementPanel) {
        this.relatedCustomPropertyAliasNameDefinitionManagementPanel = relatedCustomPropertyAliasNameDefinitionManagementPanel;
    }
