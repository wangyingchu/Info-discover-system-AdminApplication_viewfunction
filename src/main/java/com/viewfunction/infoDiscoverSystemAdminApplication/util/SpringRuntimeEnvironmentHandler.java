package com.viewfunction.infoDiscoverSystemAdminApplication.util;

public class SpringRuntimeEnvironmentHandler {

    private static String APPLICATION_ROOT_PATH;

	public static String getApplicationRootPath() {
	    if(APPLICATION_ROOT_PATH==null){
            String runtimeClassLocation=SpringRuntimeEnvironmentHandler.class.getProtectionDomain().getCodeSource().getLocation().getPath();
